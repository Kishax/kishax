package keyp.forev.fmc.velocity.socket.message.handlers.web;
...
public class VelocityMinecraftWebConfirmHandler implements MinecraftWebConfirmHandler {
    ...
    @Inject
    public VelocityMinecraftWebConfirmHandler(Logger logger, ProxyServer server, Database db, VelocityConfig config, Luckperms lp, MessageEditor discordME, Provider<SocketSwitch> sswProvider) {
        this.logger = logger;
        this.server = server;
        this.db = db;
        this.config = config;
