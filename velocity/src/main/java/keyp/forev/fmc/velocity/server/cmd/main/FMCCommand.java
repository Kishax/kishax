package keyp.forev.fmc.velocity.server.cmd.main;
...
import keyp.forev.fmc.velocity.server.cmd.sub.CEnd;
import keyp.forev.fmc.velocity.server.cmd.sub.Debug;
import keyp.forev.fmc.velocity.server.cmd.sub.Hub;
import keyp.forev.fmc.velocity.server.cmd.sub.Maintenance;
import keyp.forev.fmc.velocity.server.cmd.sub.Perm;
import keyp.forev.fmc.velocity.server.cmd.sub.ReloadConfig;
import keyp.forev.fmc.velocity.server.cmd.sub.Retry;
import keyp.forev.fmc.velocity.server.cmd.sub.ServerTeleport;
import keyp.forev.fmc.velocity.server.cmd.sub.Silent;
import keyp.forev.fmc.velocity.server.cmd.sub.StartServer;
import keyp.forev.fmc.velocity.server.cmd.sub.StopServer;
import keyp.forev.fmc.velocity.server.cmd.sub.SwitchChatType;
import keyp.forev.fmc.velocity.server.cmd.sub.SwitchRomajiConvType;
