...
import f5.si.kishax.mc.velocity.discord.interfaces.ReflectionHandler;
  ...
  public CompletableFuture<Object> loginDiscordBotAsync() {
    return CompletableFuture.supplyAsync(() -> {
      ...
      try {
        ...
        Object createKishaxCommand = upsertCommand.invoke(jdaInstance, "kishax", "Kishax commands");
        ...
        Object cmdResult = addSubcommands.invoke(createKishaxCommand, (Object) subcommandsArray);
        ...
        Object activity = playing.invoke(null, config.getString("Discord.Presence.Activity", "Kishaxサーバー"));
