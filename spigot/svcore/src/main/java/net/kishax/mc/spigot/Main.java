...
import net.kishax.mc.spigot.module.Module;
import net.kishax.mc.spigot.server.AutoShutdown;
import net.kishax.mc.spigot.server.ImageMap;
import net.kishax.mc.spigot.server.cmd.main.Command;
import net.kishax.mc.spigot.server.cmd.sub.imagemap.Q;
import net.kishax.mc.spigot.server.cmd.sub.imagemap.RegisterImageMap;
import net.kishax.mc.spigot.server.cmd.sub.teleport.Navi;
import net.kishax.mc.spigot.server.cmd.sub.teleport.RegisterTeleportPoint;
import net.kishax.mc.spigot.server.cmd.sub.teleport.TeleportAccept;
