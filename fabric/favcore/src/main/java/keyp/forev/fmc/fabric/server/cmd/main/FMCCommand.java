package keyp.forev.fmc.fabric.server.cmd.main;
...
public class FMCCommand {
  ...
  public int execute(CommandContext<ServerCommandSource> context, String subcommand) throws CommandSyntaxException {
    ...
    try {
      if (!Main.getInjector().getInstance(FabricLuckperms.class).hasPermission(source, "fmc." + subcommand)) {
