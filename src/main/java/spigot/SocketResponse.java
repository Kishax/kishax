...
public class SocketResponse {
    ...
    @Inject
    public SocketResponse(common.Main plugin, Logger logger, ServerStatusCache ssc, ServerHomeDir shd, Provider<SocketSwitch> sswProvider, AutoShutdown asd, Inventory inv) {
        this.plugin = plugin;
        this.logger = logger;
        this.ssc = ssc;
        this.shd = shd;
