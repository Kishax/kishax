package f5.si.kishax.mc.neoforge.server.cmd.main;
...
import f5.si.kishax.mc.neoforge.server.cmd.sub.ReloadConfig;
...
public class Command {
  ...
  public static int execute(CommandContext<CommandSourceStack> context, String subcommand) throws CommandSyntaxException {
    ...
    try {
      if (!Main.getInjector().getInstance(NeoForgeLuckperms.class).hasPermission(source, "kishax." + subcommand)) {
