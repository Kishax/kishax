...
public class SqsClient {
  ...
  // ファクトリーメソッド（遅延初期化用）
  public static SqsClient create(String region, String accessKey, String secretKey, String mcToWebQueueUrl,
      String apiGatewayUrl) {
    return new SqsClient(region, accessKey, secretKey, mcToWebQueueUrl, apiGatewayUrl);
  }

  // 遅延初期化メソッド
  public void initialize(String region, String accessKey, String secretKey, String mcToWebQueueUrl,
      String apiGatewayUrl) {
   ...
   * MC認証レスポンスをWebに送信
   */
  public CompletableFuture<Void> sendAuthResponse(String playerName, String playerUuid, boolean success,
      String message) {
   ...
   * プレイヤー状態変更をWebに送信
   */
  public CompletableFuture<Void> sendPlayerStatus(String playerName, String playerUuid, String status,
      String serverName) {
    Map<String, Object> payload = new TreeMap<>();
   ...
   * サーバー情報をWebに送信
   */
  public CompletableFuture<Void> sendServerInfo(String serverName, String status, int playerCount,
