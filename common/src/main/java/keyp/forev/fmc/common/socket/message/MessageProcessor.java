...
import keyp.forev.fmc.common.socket.message.handlers.interfaces.discord.*;
import keyp.forev.fmc.common.socket.message.handlers.interfaces.web.*;
import keyp.forev.fmc.common.socket.message.handlers.interfaces.minecraft.commands.*;
import keyp.forev.fmc.common.socket.message.handlers.interfaces.minecraft.*;
